...
def get_cifar10_transform(args, mean, std):
    train_transform = []
    test_transform = []
    train_transform += [
    ...
    train_transform += [RandomCropPaste(size=32)]
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR10':
        ...
        tt, tr = get_cifar10_transform(args, mean, std)
        transform = tt if is_train else tr
